...
func printHelp() {
	...
	fmt.Println()
	fmt.Println("CLIENT TOOL:")
	fmt.Println("  disco hosts         List and manage discovered hosts")
	fmt.Println("  disco services      List discovered services")
	fmt.Println("  disco lookup        Look up a hostname")
	fmt.Println("  disco status        Show daemon status")
