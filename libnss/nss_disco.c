/*
 * libnss_disco - NSS module for Disco service discovery daemon
 * Copyright (c) 2024 Flip Hess
 * 
 * This NSS module enables hostname resolution via the Disco daemon
...
#define SOCKET_PATH "/run/disco.sock"
...
enum nss_status _nss_disco_gethostbyname_r(const char *name,
                                             struct hostent *ret,
                                             char *buffer,
                                             size_t buflen,
                                             int *errnop,
...
enum nss_status _nss_disco_gethostbyname2_r(const char *name,
                                               int af,
                                               struct hostent *ret,
                                               char *buffer,
                                               size_t buflen,
...
enum nss_status _nss_disco_gethostbyaddr_r(const void *addr,
                                               socklen_t len,
                                               int af,
                                               struct hostent *ret,
                                               char *buffer,
...
enum nss_status _nss_disco_gethostbyname_r(const char *name,
                                              ...
                                              int *errnop,
                                              int *h_errnop) {
    return _nss_disco_gethostbyname2_r(name, AF_INET, ret, buffer, buflen, errnop, h_errnop);
}
